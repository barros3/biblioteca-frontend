...
@Component({
  ...
  styleUrls: ['./modal.cadastrar.assunto.component.sass']
})
export class ModalCadastrarAssuntoComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<ModalCadastrarAssuntoComponent>,
